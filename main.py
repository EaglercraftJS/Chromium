...
if __name__ == "__main__":
  print("Starting Vurtual Browser")
  ...
  if is_cookies():
    print("Looks Like Theres Some Cookies To Restore!")
    load_cookies(driver)

  if SINGLE_PAGE and is_localstorage():
    print("Found LocalStorage Data To Restore!")
  ...
  try:
    ...
    print("Sorry We Recived A Keyboard Inturupt! Sutting Down!")
  finally:
    save_cookies(driver)
    driver.close()
